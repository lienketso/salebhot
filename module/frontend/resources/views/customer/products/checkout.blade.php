    ...
    <div class="page-content">
        <div class="container bottom-content">
            <div class="content clearfix">
                ...
                <section id="DZWizardSteps-p-0" role="tabpanel" aria-labelledby="DZWizardSteps-h-0" class="body current" aria-hidden="false">
                    ...
                    <div class="mb-3 input-group input-group-icon">
                        <div class="form-item">
                            ...
                            <input type="text" name="license_plate" class="form-control" placeholder="30H74064">
                        </div>
                    </div>
                    <div class="mb-3 input-group input-group-icon">
                        <div class="form-item">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="mb-2 dz-form-select form-select" aria-label="Default select example">
                            <option selected="" class="selected">Chọn loại xe</option>
