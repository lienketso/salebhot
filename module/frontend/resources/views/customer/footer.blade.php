...
{{--<script src="{{asset('frontend/mobile/assets/vendor/apexcharts/dist/apexcharts.js')}}"></script>--}}
{{--<script src="{{asset('frontend/mobile/assets/js/dashboard/dashboard-1.js')}}"></script>--}}
