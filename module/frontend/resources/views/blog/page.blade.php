                        ...
                        <div class="post-content-area">
                            ...
                            <div class="share-items clearfix">
                                <ul class="post-social-icons unstyled">
                                    <li class="facebook">
                                        <a target="_blank" href="http://www.facebook.com/sharer/sharer.php?u={{route('frontend::page.index.get',$data->slug)}}">
                                            <i class="fa fa-facebook"></i> <span class="ts-social-title">Facebook</span></a>
                                    </li>
                                    <li class="twitter">
                                        <a target="_blank" href="https://twitter.com/intent/tweet?text={{$data->description}}&url={{route('frontend::page.index.get',$data->slug)}}&via=Y Dược cổ truyền">
                                            <i class="fa fa-twitter"></i> <span class="ts-social-title">Twitter</span></a>
                                    </li>
                                    <li class="gplus">
                                        <a target="_blank" href="https://plus.google.com/share?url={{route('frontend::page.index.get',$data->slug)}}">
                                            <i class="fa fa-google-plus"></i> <span class="ts-social-title">Google +</span></a>
                                    </li>
                                    <li class="pinterest">
                                        <a target="_blank" href="https://pinterest.com/pin/create/button/?url={{route('frontend::page.index.get',$data->slug)}}&description={{$data->description}}&media={{upload_url($data->thumbnail)}}">
                    ...
                    <nav class="post-navigation clearfix">
                        @if(!empty($prevPost))
                            <div class="post-previous">
                                <a href="{{route('frontend::page.index.get',$prevPost->slug)}}">
                        ...
                        @if(!empty($nextPost))
                            <div class="post-next">
                                <a href="{{route('frontend::page.index.get',$nextPost->slug)}}">
                                    ...
                                    <div class="item">
                                        <div class="post-block-style clearfix">
                                            <div class="post-thumb">
                                                <a href="{{route('frontend::page.index.get',$p->slug)}}">
                                                    <img class="img-fluid"
