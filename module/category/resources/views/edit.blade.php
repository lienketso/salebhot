                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <select id="" name="type" class="form-control" style="width: 100%" data-placeholder="">
                                <option value="blog" {{($data->type=='blog') ? 'selected' : ''}}>Bài viết</option>
                                <option value="product" {{($data->type=='product') ? 'selected' : ''}}>Sản phẩm</option>
                                <option value="file" {{($data->type=='file') ? 'selected' : ''}}>Tài liệu</option>
                            </select>
                        </div>
                        <div class="form-group">
