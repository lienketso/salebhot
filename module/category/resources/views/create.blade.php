        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-4">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label>Kiểu danh mục ( Phân biệt giữa sản phẩm và bài viết )</label>
                            <select id="" name="type" class="form-control" style="width: 100%" data-placeholder="">
                                <option value="blog" {{(old('type')=='blog') ? 'selected' : ''}}>Bài viết</option>
                                <option value="product" {{(old('type')=='product') ? 'selected' : ''}}>Sản phẩm</option>
                                <option value="file" {{(old('type')=='file') ? 'selected' : ''}}>Tài liệu</option>
                            </select>
                        </div>
                        <div class="form-group">
