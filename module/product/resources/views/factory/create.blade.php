...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::product.index.get')}}">Hãng bảo hiểm</a></li>
        <li class="active">Thêm Hãng bảo hiểm</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm Hãng bảo hiểm</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm Hãng bảo hiểm mới</p>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" min="0" max="100" name="link" value="{{old('link')}}" type="text" placeholder="Url đến trang web">
                        </div>
