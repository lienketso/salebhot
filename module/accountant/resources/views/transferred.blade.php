...
@section('content')
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="">Danh sách đã bank </a></li>
    </ol>
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">Danh sách đã bank </h4>
            <p>Danh sách đã bank tiền đến đại lý thành công</p>
        </div>
                    ...
                    @foreach($data as $key=>$d)
                        <tr id="tr_{{$d->id}}">
                            ...
                            <td class="order-status">
                                <span class="order-success">Đã chuyển khoản</span>
                            </td>
