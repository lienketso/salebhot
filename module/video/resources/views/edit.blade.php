...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::page.index.get',['post_type'=>'page'])}}">Video</a></li>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa Video</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để sửa Video</p>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <input type="text" id="" name="description" class="form-control" value="{{$data->description}}" placeholder="Link video">
                        </div>
                        <div class="form-group">
