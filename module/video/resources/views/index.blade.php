...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <p>Danh sách video trên trang</p>
        </div>
                ...
                <div class="row">
                    <form method="get">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a href="{{route('wadmin::video.index.get',['post_type'=>'video'])}}" class="btn btn-default">Làm lại</a>
                        </div>
                        <div class="col-sm-5">
                            <div class="button_more">
                                <a class="btn btn-primary" href="{{route('wadmin::video.create.get',['post_type'=>'video'])}}">Thêm mới</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="table-options">
                                    <li><a href="{{route('wadmin::video.edit.get',$d->id)}}"><i class="fa fa-pencil"></i></a></li>
                                    <li><a class="example-p-6" data-url="{{route('wadmin::video.remove.get',$d->id)}}"><i class="fa fa-trash"></i></a></li>
                                </ul>
                            </td>
                        </tr>
                    @endforeach
