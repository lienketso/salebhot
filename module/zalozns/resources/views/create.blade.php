...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Thêm Zalo template</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm Zalo template</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm Zalo template mới</p>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="template_model" class="form-control">
                                ...
                                <option value="company">Nhà phân phối</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Mô tả</label>
