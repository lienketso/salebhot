...
@section('content')
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="">Danh sách đơn hàng đã hoàn lại</a></li>
    </ol>
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">Danh sách đơn hàng đã hoàn lại</h4>
            <p>Danh sách đơn hàng đã hoàn lại </p>
        </div>
                ...
                <div class="row">
                    <form method="get">
                        ...
                        <div class="col-sm-2 txt-field">
                            ...
                            <a href="{{route('wadmin::transaction.refunded.get')}}" class="btn btn-default">Làm lại</a>
                        </div>
                    ...
                    @foreach($data as $d)
                        ...
                        <tr id="tr_{{$d->id}}">
                            ...
                            <td class="order-status">
                                    ...
                                    <em>Hoàn đơn ngày: {{format_date($d->updated_at)}}</em>
                            </td>
                            <td>
