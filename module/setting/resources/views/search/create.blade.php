...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::link.index.get')}}">Form search</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <dv class="form-group">
                            <div class="btn-add-search">
                                <button type="button" id="addSearch">+ Thêm trường search</button>
                            </div>
                            <div class="search-form-list" id="SearchList">
