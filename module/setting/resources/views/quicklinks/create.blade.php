                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <select id="" name="display" class="form-control" style="width: 100%" data-placeholder="Trạng thái">
                                ...
                                <option value="1" {{ (old('display') ==1 ) ? 'selected' : ''}}>Top</option>
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="status" class="form-control" style="width: 100%" data-placeholder="Trạng thái">
                                <option value="active" {{ (old('status')=='active') ? 'selected' : ''}}>Đăng ngay</option>
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="target" class="form-control" style="width: 100%" data-placeholder="Trạng thái">
                                <option value="_self" {{ (old('target') =='_seft' ) ? 'selected' : ''}}>Trên trang</option>
                                <option value="_blank" {{ (old('target') =='_blank' ) ? 'selected' : ''}}>Nhẩy trang mới</option>
                                <option value="_parent" {{ (old('target') =='_parent' ) ? 'selected' : ''}}>Mở trên tab</option>
                            </select>
                        </div>
